...
namespace Microsoft.Dynamics365.UIAutomation.Browser {
    ...
    public sealed class DynamicsJsonConverter : Newtonsoft.Json.JsonConverter {
        ...
        public object Deserialize(IDictionary<string, object> dictionary, Type type, JsonSerializer serializer) {
            ...
            return type == typeof(object) ? JsonConvert.DeserializeObject(dictionary.ToString()) : null;
        }
