...
namespace Microsoft.Dynamics365.UIAutomation.Sample.ProjectOps
{
    public static class BookableResource
    {
        ...
        public static string Name = "msdyn_name";
        public static string BookableResourceId = "msdyn_bookableresourceid";

    }

    [TestClass]
    public class CreateBookableResource
    {
        ...
        public void ProjectOpsTestCreateBookableResource()
        {
            ...
            using (var xrmApp = new XrmApp(client))
            {
                ...
                xrmApp.Navigation.OpenSubArea("Resources", "Resources");

                xrmApp.CommandBar.ClickCommand("New");

                xrmApp.Entity.SetValue(new OptionSet() { Name = BookableResource.ResourceType, Value = "Contact" });

                xrmApp.Entity.SetValue(BookableResource.Name, "Abraham McCormick");

                xrmApp.Entity.SetValue(new LookupItem() { Name = BookableResource.BookableResourceId, Value = "Abraham McCormick" });
