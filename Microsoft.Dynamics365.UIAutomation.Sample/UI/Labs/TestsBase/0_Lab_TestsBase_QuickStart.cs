...
namespace Microsoft.Dynamics365.UIAutomation.Sample
{
    ...
    public class Lab_TestsBase_QuickStart : TestsBase
    {
        ...
        public override void NavigateToHomePage() => NavigateTo(AppName.Sales, "Sales", "Accounts"); // => NavigateTo( App, Area, Sub Area ) in all tests
       
        // Optional: this will override the default parameters values & from  this app.config
        public override void SetOptions(BrowserOptions options) => options.PerformanceMode = false; // => set options for all tests in this class
