    ...
    public class PerformanceCenter
        ...
        public BrowserCommandResult<Dictionary<string, PerformanceMarker>> GetMarkers() {
            return this.Execute("Get Performance Markers", driver =>
            {
                ...
                var perfMarkers = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, PerformanceMarker>>(jsonResults);
        ...
        public BrowserCommandResult<Dictionary<string, object>> GetMarkersRaw() {
            return this.Execute("Get Performance Markers (raw)", driver =>
            {
                ...
                // (Dictionary<string, object>)jsSerializer.Deserialize(jsonResults, typeof(Dictionary<string, object>));
                var jsonObj = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(jsonResults);
                //var jsonObj = (Dictionary<string, object>)Newtonsoft.Json.JsonConvert.DeserializeObject<(jsonResults, typeof(Dictionary<string, object>));
                return jsonObj;
            });
        }
